        ...
        <>
            <header>
                <div>
                    <img
                        ...
                        alt="Company Logo"
                    />
                    <p className="txt-firsat">fırsatı kaçırma</p>
                    <p className="txt-pizza">KOD ACIKTIRIR, <br /> PİZZA DOYURUR</p>
                    <Link to="/order">
            ...
            <section className="icon-section">
                <nav className="icons">
                    ...
                    <li className="li-icons">
                        <img src="/images/iteration-2-images/icons/6.svg" alt="Gazlı İçecekler" />
                        <p>Gazlı İçecekler</p>
                    </li>
                </nav>
            </section>
            ...
            <section className="burger-section">
                <div className="ozel-lezzetus">
                    <div className="lezzetus">
                        <p className="p-ozel-lezzetus">Özel <br /> Lezzetus</p>
                ...
                <section className="section-pizza">
                    <div className="pizza">
                        <img src="/images/iteration-2-images/pictures/food-1.png" className="section-img" alt="pizza" />
                        <p>Terminal Pizza</p>
                    ...
                    <div className="aci-pizza">
                        <img src="/images/iteration-2-images/pictures/food-2.png" className="section-img" alt="aci-pizza" />
                    ...
                    <div className="tavuklu-burger">
                        <img src="/images/iteration-2-images/pictures/food-3.png" className="section-img" alt="tavuklu-pizza" />
                ...
                <div className="footer-iletisim">
                    <div className="iletisim">
                        ...
                        <div className="iletisim-item">
                            <img src="/images/iteration-2-images/footer/icons/icon-1.png" alt="address" />
                            <p>341 Londonderry Road, <br /> Istanbul/Turkiye</p>
                        </div>
                        <div className="iletisim-item">
